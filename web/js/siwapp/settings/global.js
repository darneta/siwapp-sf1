...
jQuery(function($) {
  ...
  $('#settings-wrapper #taxes ul a.remove, #settings-wrapper #seriess ul a.remove, #settings-wrapper #addNewUnit ul a.remove').live('click', function(e){
    e.preventDefault();
    // Find item
  ...
  $('#addNewTax, #addNewSeries, #addNewUnit').click(function(e){
    e.preventDefault();
    var a = $(this);
    // Find target element
