...
abstract class BaseTemplateForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'email_title'       => new sfWidgetFormTextarea(),
      'email_template'   => new sfWidgetFormTextarea(),
      'email_filename'   => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'email_title'       => new sfValidatorString(array('required' => false)),
      'email_template'   => new sfValidatorString(array('required' => false)),
      'email_filename'   => new sfValidatorString(array('required' => false)),
